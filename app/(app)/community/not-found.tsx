  ...
  return (
    <div className="min-h-dvh bg-[#f7f9fb] px-6 pt-28">
      <div className="mx-auto max-w-mobile rounded-[24px] border border-white/40 bg-white/75 p-7 text-center shadow-lg">
        <h1 className="text-xl font-extrabold text-primary">ข้อมูลนี้ถูกลบหรือไม่มีอยู่แล้ว</h1>
        <p className="mt-3 text-sm leading-6 text-[#3e494a]">เนื้อหาอาจถูกลบ ซ่อน หรือคุณไม่มีสิทธิ์เข้าถึง</p>
