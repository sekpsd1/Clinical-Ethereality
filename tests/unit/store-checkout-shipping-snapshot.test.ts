...
vi.mock("@/features/orders/reservations", () => ({ assertStorePendingOrderCapacity: vi.fn(), releaseExpiredStoreOrderReservations: mocks.releaseExpiredStoreOrderReservations, StorePendingOrderLimitError: class StorePendingOrderLimitError extends Error {} }));
