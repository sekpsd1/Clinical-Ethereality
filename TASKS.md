...
- [ ] Review and deploy the code-only Admin SMS OTP schema-readiness check, then inspect its allowlisted `ready | not_ready | unavailable` component statuses in the Admin runtime before deciding whether any migration or a third OTP UAT is appropriate.
