...
- [ ] Deploy and probe the request-preflight diagnostics, then run the separately controlled one-request Production OTP UAT with no resend/retry and stop on the first safe failure category.
