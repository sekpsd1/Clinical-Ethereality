...
- Staff/admin queue copy polish: `/admin/inventory`, `/admin/payments`, `/admin/orders`, `/admin/schedules`, and `/pharmacist/prescriptions` now reduce remaining English-facing operational copy while preserving existing role flows and Stitch-style surfaces.
