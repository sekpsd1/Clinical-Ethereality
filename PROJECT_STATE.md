...
- Domain service coverage has started with shared order fulfillment transitions for admin/pharmacist workflows and doctor-issued prescription rules for consultation readiness, ownership, audit logging, and notifications; additional services should be added as more sensitive workflows are implemented.
