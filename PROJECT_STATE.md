...
- Community image uploads remain disabled until private Cloudinary/S3-compatible object storage is configured, and final Community rules/moderation policy still require owner approval. Persisted shipping addresses remain incomplete. Doctor production work now mainly remains Zoom credential/UAT validation and deciding whether polling should be replaced by a dedicated realtime transport.
