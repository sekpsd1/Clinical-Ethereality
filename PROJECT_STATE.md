...
- Production PromptPay identifier has been received and must be configured securely through `THAI_QR_PROMPTPAY_ID`; dynamic Thai QR payload generation is implemented for store checkout orders.
