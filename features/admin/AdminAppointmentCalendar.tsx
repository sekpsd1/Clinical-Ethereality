...
const statusPresentation = {
  ...
  closed: { label: "ปิดรับนัด", tone: "neutral", className: "border-border bg-surface text-muted" }
} as const;
