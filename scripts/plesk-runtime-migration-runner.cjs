...
const ZOOM_ATTENDANCE_GATE_MIGRATION_TARGET = "20260906120000_add_zoom_attendance_gate";
const BLOCKED_DOCTOR_DATE_OVERRIDE_MIGRATION_TARGET = "20260907120000_add_blocked_doctor_date_override";
const CONSULTATION_PRESCRIPTION_OUTCOME_MIGRATION_TARGET =
  "20260908120000_add_consultation_prescription_outcome";
const PATIENT_NATIONAL_ID_MIGRATION_TARGET = "20260910160000_add_patient_national_id";
const COMMUNITY_PINNED_ARTICLES_MIGRATION_TARGET = "20260914120000_add_community_pinned_articles";
const DOCTOR_INVITATIONS_MIGRATION_TARGET = "20260916190000_add_doctor_invitations";
